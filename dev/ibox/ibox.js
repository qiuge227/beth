(function(window) {
    var navigator = window.navigator,
        ...
        computeWidth = function(el, width) {
            ...
            return width - parsePx(style.marginLeft) - parsePx(style.marginRight) - parsePx(style.borderLeftWidth) - parsePx(style.borderRightWidth);
        },
        computeHeight = function(el, height) {
            var style = window.getComputedStyle(el, null);
            return height - parsePx(style.marginTop) - parsePx(style.marginBottom) - parsePx(style.borderTopWidth) - parsePx(style.borderBottomWidth);
        },
    ...
    var iBox = function(target, config) {
        ...
        if (this.headerCls) {
            this.el.classList.add(this.headerCls);
        }
